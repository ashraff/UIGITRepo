namespace CryptoExamples.DES
{
    ...
    class DESConstats
    {
        ...
        public static int[,] EXPANSION_FUNCTION = new int[8, 6] 
        {
                {32 , 1  , 2  , 3  , 4  , 5 },
                {4  , 5  , 6  , 7  , 8  , 9 },
                {8  , 9  , 10 , 11 , 12 , 13},
        ...
        public static int[,] FINAL_PERMUTATION = new int[8, 8]
        {
        ...
        public static int[,] INITAL_PERMUTATION = new int[8, 8] 
        {
        ...
        public static int[,] KEY_SCHEDULE_ROTATION = new int[16, 2]
        {
                  {1 , 1},
                  {2 , 1},
                  {3 , 2},
        ...
        public static int[,] PERMUTATION = new int[8, 4] 
        {
                 {16 , 7 , 20 , 21} ,
                 {29 , 12 , 28 , 17} ,
                 {1 , 15 , 23 , 26} ,
        ...
        public static int[,] PERMUTED_CHOICE_ONE = new int[8, 7] 
        {
                {57 , 49 , 41 , 33 , 25 , 17 , 9 },
                {1  , 58 , 50 , 42 , 34 , 26 , 18},
                {10 , 2  , 59 , 51 , 43 , 35 , 27},
        ...
        public static int[,] PERMUTED_CHOICE_TWO = new int[8, 6] 
        {
                {14 , 17 , 11 , 24 ,  1 ,  5},
                {3 ,  28 , 15 ,  6 , 21 , 10},
                {23 , 19 , 12 ,  4 , 26 ,  8},
        ...
        public static int[, ,] SBOXES = new int[8, 4, 16]
        {
                  ...
                  {09 , 14 , 15 , 5 , 2 , 8 , 12 , 3 , 7 , 0 , 4 , 10 , 1 , 13 , 11 , 6},
        ...
        public static int[,] CB_INITAL_PERMUTATION = new int[8, 8] 
        {
                {58 , 50 , 42 , 34 , 26 , 18 , 10 , 2},
                {60 , 52 , 44 , 36 , 28 , 20 , 12 , 4},
                {62 , 54 , 46 , 38 , 30 , 22 , 14 , 6},
